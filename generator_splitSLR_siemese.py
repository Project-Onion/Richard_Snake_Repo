...
def deepnn(x, keep_prob):
    ...
    with tf.name_scope('conv1_1'):
        W_conv1_1 = weight_variable([7, 7, 3, 16]) #feature size 7x7 to have 46x46 image after convolution
        b_conv1_1 = bias_variable([16]) #32 feature maps - arbitrary - can change
    ...
    with tf.name_scope('pool1_1'):
        h_pool1_1 = max_pool_2x2(h_conv1_1) #now size will be 23x23x32

    # Second convolutional layer -- maps 32 feature maps to 64.
    with tf.name_scope('conv2_1'):
        W_conv2_1 = weight_variable([5, 5, 16, 32]) #feature size 5x5 to have 19x19  image after convolution
    ...
    with tf.name_scope('pool2_1'):
         h_pool2_1 = max_pool_2x2(h_conv2_1) #now size will be 9x9x64

    # Third convolutional layer -- maps 32 feature maps to 64.
    with tf.name_scope('conv3_1'):
         W_conv3_1 = weight_variable([3, 3, 32, 64]) #feature size 3x3 to have 8x8 image after convolution
         b_conv3_1 = bias_variable([64])
         h_conv3_1 = tf.nn.relu(conv2d(h_pool2_1, W_conv3_1) + b_conv3_1)

    # First convolutional layer - maps one grayscale image to 32 feature maps.
    with tf.name_scope('conv1_2'):
        W_conv1_2 = weight_variable([7, 7, 3, 16]) #feature size 7x7 to have 46x46 image after convolution
        b_conv1_2 = bias_variable([16]) #32 feature maps - arbitrary - can change
    ...
    with tf.name_scope('pool1_2'):
        h_pool1_2 = max_pool_2x2(h_conv1_2) #now size will be 23x23x32

    # Second convolutional layer -- maps 32 feature maps to 64.
    with tf.name_scope('conv2_2'):
        W_conv2_2 = weight_variable([5, 5, 16, 32]) #feature size 5x5 to have 19x19  image after convolution
    ...
    with tf.name_scope('pool2_2'):
         h_pool2_2 = max_pool_2x2(h_conv2_2) #now size will be 9x9x64

    # Third convolutional layer -- maps 32 feature maps to 64.
    with tf.name_scope('conv3_2'):
         W_conv3_2 = weight_variable([3, 3, 32, 64]) #feature size 3x3 to have 8x8 image after convolution
    ...
    with tf.name_scope('fc1'):
        ...
        h_conv3_flat = tf.reshape(tf.concat((h_conv3_1, h_conv3_2), axis=1), [-1, 7 * 7 * 128])
