...
def boardSplitter(board):
    return [np.array([[pixel if (pixel == 1 or pixel == 2 or pixel == 3) else 0 for pixel in board], [pixel if (pixel == 4 or pixel ==5) else 0 for pixel in board], [pixel if (pixel == 6 or pixel == 7) else 0 for pixel in board]]).flatten()]
