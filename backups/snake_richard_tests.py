...
def main(_):
    ...
    amountOfMiniBatchFilesToTest = 40
...
#            learning_rate = tf.placeholder(tf.float32, name="learning_rate") #1e-3
            learning_rate = tf.train.exponential_decay(starting_learning_rate, global_step, 100, 0.96, staircase=True)
...
#        print("Variables initialized ...")
    ...
    sys.stdout.flush()
    fileLocation = "/mnt/snake/snakeNN/snakeNN_data/"
